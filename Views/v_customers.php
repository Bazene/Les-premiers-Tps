...
<body> 
        ...
        <section class="customer_search">
            <form method="POST" action="" enctype="multipart/form-data">
                <input type="number" name="id_search" placeholder="customer search" style="width:200px;">
                <input type="submit" value="Search" style="width:100px; margin-left:10px; background-color:rgb(13, 13, 155); color:white; cursor:pointer;">
            </form>
        </section>
