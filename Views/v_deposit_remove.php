                ...
                <form action="../Controllers/c_deposit_remove.php" method="POST">
                    <div style="display: flex; flex-direction:row; justify-content: space-between; margin:10px 0px 10px 0px; width:100%;">
                        <div style="display: flex; flex-direction:row; justify-content: flex-start; width:60%; margin:0px 0px 0px 12px;">
                            <label for="operation_type" style="padding:10px; background-color:rgb(25, 132, 210); color:white;">Operation type</label>
                            <select name="operation_type" style="width:100px; background-color:white; padding:10px;">
                    ...
                    <div style="display: flex; flex-direction:row; justify-content:center; width:100%;">
                        ...
                        <input type="number" name='amount' placeholder="Amount to deposit or withdraw" style="width:70%;">
                        <input type="submit" value="Confirm" style="width:20%; background-color:rgb(13, 13, 155); color:white; border:0px; cursor:pointer;">
                    </div>
                </form>
            </section>
        </section>
